...
#Q1: Which state had the highest number of COVID-19 cases per 1,000 people on August 30, 2020?
#A1: Louisiana had highest # of COVID cases per 1,000 on Aug. 30, 2020. It was 31.666 cases per 1,000.

highest_covid_cases_per_1000 <- state_covid_population %>%
  mutate(cases_per_1k = round(total_cases/population*1000, digits=3)) %>%
  arrange(desc(cases_per_1k))

highest_covid_cases_per_1000

#---------------

#Q2: Which state had the lowest # of COVID deaths per 1,000 people on Aug 30, 2020.
#A2: Hawaii had lowest # of COVID deaths per 1,000 on Aug. 30, 2020. It was 0.044 deaths per 1,000.

lowest_covid_death_per_1000 <- state_covid_population %>%
  mutate(deaths_per_1k = round(total_deaths/population*1000, digits=3)) %>%
  arrange(deaths_per_1k)

lowest_covid_death_per_1000
