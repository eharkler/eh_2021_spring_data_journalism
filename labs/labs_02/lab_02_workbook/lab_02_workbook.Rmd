...
```{r}
# use glimpse() fn on Baltimore data
...
#creates a new dataframe called sorted, arranges it in descending order based on # of pills
...
arcos_md_baltimorecity_trimmed_sorted <- arcos_md_baltimorecity_trimmed %>%
...
```{r}
# Answer to question 2: OSHINSKY, ALAN E MD & JAKOBOVITS, JULIAN MD got 4 pills.

arcos_md_baltimorecity_trimmed_sorted <-
  arcos_md_baltimorecity_trimmed %>%
    arrange(total_dosage_unit)
