...
# A: Prince George's County had the highest case rate on Aug. 30. The case rate was 29.27 cases per 1,000 people.
...
# A: Bath County had the lowest case rate in Virginia on Aug. 30. The case rate was 0.91 cases per 1,000 people.
...
# A: Two areas in the U.S. had a death rate above 4 per 1,000 in August. They were Hancock County, Georgia and Galax city, Virginia.
...
# A: Kent County was the only MD county with a death rate higher than 1 per 1,000 in August.
...
# A: Galax city, Emporia city, and Northampton County had death rates higher than 2 per 1,000 in August.
...
```
``` {r}
#filter for places containing the word "city"
...
# A: Lafeyette County, Florida had the biggest jump in cumulative case rate between July and August.
...
# A: Luce County, Michigan had the largest % jump in cumulative case rate between July and August.
...
covid_maryland_jun_aug_death_pct_change <- covid_county_monthly_death_rate %>%
...
covid_maryland_jun_aug_death_pct_change

# Q: which Maryland county had the largest percentage change in cumulative death rate between June and August? 
# A: Queen Anne's County had the largest % change in cumulative death rate btwn June and August.
...
covid_texas_may_aug_case_pct_change <- covid_county_monthly_case_rate %>%
...
covid_texas_may_aug_case_pct_change

#Answer: Jones County, Texas has the smallest % change in cumulative case rate between May & August.
...
```{r}
#Q: Which county in Oregon had the largest percentage change in death rate between April and August?

covid_oregon_april_aug_death_pct_change <- covid_county_monthly_death_rate %>%
  select(county, state, d_2020_04_30, d_2020_08_30) %>%
    mutate(april_aug_pct_change = (d_2020_08_30 - d_2020_04_30)/ d_2020_04_30*100) %>%
  filter(state == "Oregon") %>%
  arrange(desc(april_aug_pct_change))


covid_oregon_april_aug_death_pct_change

#A: Polk County, Oregon had the greatest % change in cumulative death rate between April and August. It increased by 1300%.
