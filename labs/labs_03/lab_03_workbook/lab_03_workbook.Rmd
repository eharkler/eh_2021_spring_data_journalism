...
covid_oregon_april_aug_death_pct_change <- covid_county_monthly_death_rate %>%
  select(county, state, d_2020_04_30, d_2020_08_30) %>%
    mutate(april_aug_pct_change = (d_2020_08_30 - d_2020_04_30)/ d_2020_04_30) %>%
  filter(state == "Oregon") %>%
...
#A: Polk County, Oregon had the greatest % change in cumulative death rate between April and August. It increased by 13%.
