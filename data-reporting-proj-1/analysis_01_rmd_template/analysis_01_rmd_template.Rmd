...
counts_of_race <- unarmed_women_by_race %>%
  ...
  count() %>%
  arrange(desc(n))
  # Also can use count(race, race, wt = NULL, sort = TRUE, name = NULL) instead
